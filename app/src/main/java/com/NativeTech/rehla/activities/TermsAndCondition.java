...
public class TermsAndCondition extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hud = KProgressHUD.create(TermsAndCondition.this)
        ...
        if (Validation.isConnected(TermsAndCondition.this))
        {
            hud.show();
        ...
        {
            buildDialog(TermsAndCondition.this).show().setCanceledOnTouchOutside(false);
        }
    ...
    private void handleResponse(MetaDataResponseModel metaDataResponseModel) {
        ...
        {
            if (metaDataResponseModel.getModel().getTermAndConditions()!=null)
            {
                if (Language.equals("en"))
                {
                    txt.setText(metaDataResponseModel.getModel().getTermAndConditions()[0].getDiscription());
                }
                else
                {
                    txt.setText(metaDataResponseModel.getModel().getTermAndConditions()[0].getDiscriptionLT());
                }
            }
        }
        hud.dismiss();
