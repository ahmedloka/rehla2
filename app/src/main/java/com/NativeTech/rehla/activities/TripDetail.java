...
public class TripDetail extends AppCompatActivity {
    ...
    private List<CarColors> carColors=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile.setOnClickListener(v -> {
            Intent intent = new Intent(TripDetail.this, DriverDetails.class);
        ...
        track_on_map.setOnClickListener(v -> {
            Intent intent = new Intent(TripDetail.this, ViewOnMap.class);
            //Constant.captin_id=user_id;
            startActivity(intent);
        });
        ...
        selectPaymentType.setOnClickListener(v -> {
            ...
            builder1 = new AlertDialog.Builder(TripDetail.this);
...
//                        select_Area_All.setText(SelectedAreaName);
        ...
        minus_seat_num.setOnClickListener(v -> {
            try
            {
                ...
                if (p<1)
                {
                    ...
                    {
                        Toast.makeText(TripDetail.this, "يجب ان يكون عدد المقاعد اكبر من صفر", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                        Toast.makeText(TripDetail.this, "must be greater than Zero", Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
            ...
            {
                Toast.makeText(TripDetail.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        plus_seat_num.setOnClickListener(v -> {
            try {
                ...
                if (p>Integer.parseInt(Max_seat_number))
                {
                    if (Language.equals("ar"))
                    {
                        Toast.makeText(TripDetail.this, "هذا اقصي عدد مسموح به", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                        Toast.makeText(TripDetail.this, "This is the maximum number allowed", Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
        ...
        hud = KProgressHUD.create(TripDetail.this)
        ...
        RequestBook.setOnClickListener(v -> {
            if (Language.equals("ar"))
            {
                ...
                {
                    if (Validation.isConnected(TripDetail.this))
                    {
    ...
    private void handleResponse2(updateTripStatusResponse addReservationResponse) {
        ...
        try {
            if (addReservationResponse.getErrors().getMessage()==null)
            {
                ...
                builder = new android.support.v7.app.AlertDialog.Builder(TripDetail.this);
                ...
                ok.setOnClickListener(v2 -> {
                    dialog.dismiss();
                    Intent intent = new Intent(TripDetail.this, Login.class);
    ...
    private void getTripDetails()
    {
        if (Validation.isConnected(TripDetail.this))
        {
            ...
            buildDialog(TripDetail.this).show().setCanceledOnTouchOutside(false);
        }
    }
    ...
    private void handleResponseMetaData(MetaDataResponseModel metaDataResponseModel) {
        if (metaDataResponseModel.getModel()!=null)
        {
            ...
            carColors= metaDataResponseModel.getModel().getCarColors();
    ...
    private void handleResponse(getTripDetailsResponse getTripDetailsResponse) {
        ...
        if (carColors!=null)
        {
            ...
            {
                if (getTripDetailsResponse.getModel().getCar().getCarColorId().equals(String.valueOf(carColors.get(i).getId())))
                {
                    if (Language.equals("ar"))
                    {
                        car_color.setText(carColors.get(i).getNameLT());
                    }
                    else
                    {
                        car_color.setText(carColors.get(i).getName());
                    }
                }
            }
        }
    ...
    private void initRecyclerView() {
        RecyclerViewAdapterPassenger adapter2 = new RecyclerViewAdapterPassenger(TripDetail.this,rowItem);
        recyclerView.setHasFixedSize(true);
        LinearLayoutManager mRecyclerViewLayoutManager2 = new LinearLayoutManager(TripDetail.this, LinearLayoutManager.VERTICAL, false);
            ...
            if (throwable instanceof retrofit2.HttpException) {
                ...
                switch (code) {
                    ...
                    case "17":
                        ...
                        break;
                   case "36":
                        message = getString(R.string.error_36);
                        break;
                    case "18":
