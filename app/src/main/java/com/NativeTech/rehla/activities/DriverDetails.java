...
public class DriverDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hud = KProgressHUD.create(DriverDetails.this)
...
*/
    ...
    private void initRecyclerViewReviews() {
        RecyclerViewAdapterReviews adapter2 = new RecyclerViewAdapterReviews(DriverDetails.this,rowItem);
        recyclerViewReviews.setHasFixedSize(true);
        LinearLayoutManager mRecyclerViewLayoutManager2 = new LinearLayoutManager(DriverDetails.this, LinearLayoutManager.VERTICAL, false);
    ...
    {
        if (Validation.isConnected(DriverDetails.this))
        {
            ...
            mSubscriptions.add(NetworkUtil.getRetrofitByToken(DataManager.getInstance().getCashedAccessToken().getAccess_token())
                    .GetDriverProfile(Constant.captin_id)
                    .observeOn(AndroidSchedulers.mainThread())
                    .subscribeOn(Schedulers.io())
                    .subscribe(this::handleResponse, this::handleError));
        }
        else {
            buildDialog(DriverDetails.this).show().setCanceledOnTouchOutside(false);
        }
    }
    ...
    private void handleResponse(DriverProfileResponseModel driverProfileResponseModel) {
        ...
        if (Validation.isConnected(DriverDetails.this))
        {
            //hud.show();
            mSubscriptions.add(NetworkUtil.getRetrofitByToken(DataManager.getInstance().getCashedAccessToken().getAccess_token())
                    .getAllRatesByUserId(Constant.captin_id,"0")
                    .observeOn(AndroidSchedulers.mainThread())
                    .subscribeOn(Schedulers.io())
