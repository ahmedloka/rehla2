...
public class RateADriver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rate_adriver);
        ...
        hud = KProgressHUD.create(RateADriver.this)
        ...
        rateFactors.setOnClickListener(v -> {
            ...
            builder1 = new AlertDialog.Builder(RateADriver.this);
...
//                        select_Area_All.setText(SelectedAreaName);
        ...
        if (Validation.isConnected(RateADriver.this))
        {
            hud.show();
        ...
        {
            buildDialog(RateADriver.this).show().setCanceledOnTouchOutside(false);
        }
    ...
    private void handleResponseRate(RateDriverResponse rateDriverResponse) {
        if (rateDriverResponse.getModel()!=null)
        {
            ...
            builder = new android.support.v7.app.AlertDialog.Builder(RateADriver.this);
