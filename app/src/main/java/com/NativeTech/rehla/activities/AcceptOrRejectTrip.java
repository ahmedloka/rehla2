...
import com.NativeTech.rehla.adapters.AcceptRejectRecyclerModel;
import com.NativeTech.rehla.adapters.RecyclerViewAdapterAcceptOrRejectTrip;
...
public class AcceptOrRejectTrip extends AppCompatActivity {


    private RecyclerView recyclerView;
    private List<AcceptRejectRecyclerModel> rowItem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accept_or_reject_trip);
        ...
        hud = KProgressHUD.create(AcceptOrRejectTrip.this)
    ...
    private void initRecyclerView() {
        RecyclerViewAdapterAcceptOrRejectTrip adapter2 = new RecyclerViewAdapterAcceptOrRejectTrip(AcceptOrRejectTrip.this,rowItem);
        recyclerView.setHasFixedSize(true);
        LinearLayoutManager mRecyclerViewLayoutManager2 = new LinearLayoutManager(AcceptOrRejectTrip.this, LinearLayoutManager.VERTICAL, false);
    ...
    {
        if (Validation.isConnected(AcceptOrRejectTrip.this))
        {
            ...
            */
            ...
            buildDialog(AcceptOrRejectTrip.this).show().setCanceledOnTouchOutside(false);
        }
    }
        ...
        if (acceptOrRejectResponse.getModel()!=null)
        {
            if (Language.equals("ar"))
            {
                for (int i=0;i<acceptOrRejectResponse.getModel().size();i++)
                {
                    ...
                    {
                        rowItem.add(new AcceptRejectRecyclerModel(
