...
public class RecyclerViewAdapterMyOfferedUpcomingRide extends RecyclerView.Adapter<RecyclerViewAdapterMyOfferedUpcomingRide.ViewHolder> {

    private final List<MyOfferedUpcomingRideItemRecyclerModel> rowItem;
    ...
    public RecyclerViewAdapterMyOfferedUpcomingRide(Context context, List<MyOfferedUpcomingRideItemRecyclerModel> rowItem ) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_rides_item_upcoming, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        if (Language.equals("ar"))
        {
            switch (rowItem.get(position).getStatusRide()) {
                case "1":
                    holder.statusRide.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.button_rate));
                ...
                case "2":
                    ...
                    holder.statusRide.setText("تم القبول");
                    holder.canceled_ride.setVisibility(View.GONE);
        ...
        else
        {
            switch (rowItem.get(position).getStatusRide()) {
                ...
                case "2":
                    holder.statusRide.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.ride_status_green));
                    holder.statusRide.setText("Accepted");
                    holder.canceled_ride.setVisibility(View.GONE);
                    holder.call.setVisibility(View.VISIBLE);
                    holder.message.setVisibility(View.VISIBLE);
                    holder.cancel.setVisibility(View.VISIBLE);
        ...
        holder.message.setOnClickListener(view -> {
           ...
           /* if (ID.equals(rowItem.get(position).getSenderId()))
            ...
            hud.show();
            Constant.PartnerId=rowItem.get(position).getDriverId();
            Constant.PartnerIdentityId=rowItem.get(position).getDriverIdentityId();
            Constant.ReciverId=rowItem.get(position).getDriverId();
            Constant.ReciverName=rowItem.get(position).getDriverName();
            Constant.ReciverPhoto=rowItem.get(position).getDriverProfilePhoto();
        ...
        holder.btn_cancel.setOnClickListener(v -> updateTripStatus(rowItem.get(position).getId()));
    ...
    private void updateTripStatus(String id)
    {
    ...
    private void handleResponse(updateTripStatusResponse acceptOrRejectActionResponse)
    {
        if (acceptOrRejectActionResponse.getErrors().getMessage()==null)
        {
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        final AppCompatImageView btn_message;
        final AppCompatImageView btn_call;
        final TextView btn_cancel;
        final LinearLayoutCompat canceled_ride;
        final LinearLayoutCompat call;
        final LinearLayoutCompat message;
        final LinearLayoutCompat cancel;
