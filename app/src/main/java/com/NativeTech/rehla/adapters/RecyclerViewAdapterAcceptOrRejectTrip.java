...
public class RecyclerViewAdapterAcceptOrRejectTrip extends RecyclerView.Adapter<RecyclerViewAdapterAcceptOrRejectTrip.ViewHolder> {

    private final List<AcceptRejectRecyclerModel> rowItem;
    ...
    public RecyclerViewAdapterAcceptOrRejectTrip(Context context, List<AcceptRejectRecyclerModel> rowItem) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.accept_reject_trip_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.date.setText(TerhalUtils.parseDateTo_yyyyMMdd(Constant.dateCaptin));
        // holder.date.setText(rowItem.get(position).getDate());
        if (rowItem.get(position).getTrip_status().equals("1")) {
            holder.call.setVisibility(View.GONE);
            holder.chat.setVisibility(View.GONE);
            holder.accept.setVisibility(View.VISIBLE);
            holder.reject.setVisibility(View.VISIBLE);
        } else if (rowItem.get(position).getTrip_status().equals("2")) {
        ...
        holder.accept.setOnClickListener(v -> {
            ...
            mContext.startActivity(intent);*/
            updateTripStatus(rowItem.get(position).getId(),"true");
        });
        holder.reject.setOnClickListener(v -> {
            /*Intent intent = new Intent(mContext,TripDetails.class);
            Constant.tripIdSearch=rowItem.get(position).getId();
            mContext.startActivity(intent);*/
            updateTripStatus(rowItem.get(position).getId(),"false");
        });
